...
void ProblemGenerator::UserProblem(ParameterInput *pin, const bool restart) {
  ...
  Real center[3] = {2,2,2};
  Real extend[3] = {2,2,2};
  int numpoints[3] = {2,2,2};

  CartesianGrid *cart_grid = new CartesianGrid(pmbp, center, extend, numpoints);
  cart_grid->InterpolateToGrid(16, pmbp->padm->u_adm);

  std::cout << cart_grid->interp_indcs.h_view(0,0,0,0) << std::endl;
  std::cout << cart_grid->interp_indcs.h_view(0,0,0,1) << std::endl;
  std::cout << cart_grid->interp_indcs.h_view(0,0,0,2) << std::endl;
  std::cout << cart_grid->interp_indcs.h_view(0,0,0,3) << std::endl;

  std::cout << cart_grid->interp_vals.h_view(0,0,0,0) << std::endl;
  std::cout << cart_grid->interp_vals.h_view(0,0,1,0) << std::endl;
  std::cout << cart_grid->interp_vals.h_view(0,1,0,0) << std::endl;
  std::cout << cart_grid->interp_vals.h_view(0,1,1,0) << std::endl;
  std::cout << cart_grid->interp_vals.h_view(1,0,0,0) << std::endl;
  std::cout << cart_grid->interp_vals.h_view(1,0,1,0) << std::endl;
  std::cout << cart_grid->interp_vals.h_view(0,1,1,0) << std::endl;
  std::cout << cart_grid->interp_vals.h_view(1,0,1,0) << std::endl;
